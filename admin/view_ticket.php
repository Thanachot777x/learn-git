...
if (!$ticket_id) {
    header("Location: " . BASE_URL . "/admin/manage_tickets.php");
    exit();
}

// ดึงรายละเอียด Ticket (admin ดูได้ทุก ticket)
$stmt = $pdo->prepare("
    SELECT t.*, 
...
<div class="view-header">
    <div class="d-flex align-items-center gap-3">
        <a href="<?= BASE_URL ?>/admin/manage_tickets.php" class="btn-back">
    ...
    <div class="d-flex align-items-center gap-2">
        ...
        <a href="<?= BASE_URL ?>/admin/manage_tickets.php" class="btn-manage">
